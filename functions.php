...
/* ============================================================================================================================================ */
	...
	function theme_enqueue()
	{
		...
		wp_register_script( 'jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js', null, null );
		...
		wp_register_script( 'twitter-fetcher', get_template_directory_uri() . '/js/twitterFetcher_v10_min.js', null, null, true );
		...
		if ( is_singular() == false ) { wp_enqueue_script( 'main' ); }
	...
	function my_meta_box_sidebar()
	{
		...
		?>
			<div class="admin-inside-box">
				...
				<p class="howto">
					- Page with Sidebar template must be selected.
					<br>
					<br>
...
/* ============================================================================================================================================ */
	...
	{
		return ' ... <a class="read-more" href="' . get_permalink( get_the_ID() ) . '">' . __( 'Read More', 'bookcard' ) . '</a>';
	}
...
/* ============================================================================================================================================ */
	...
	function my_customize_register( $wp_customize )
	{
		...
		$wp_customize->add_setting( 'setting_open_button_font', array(	'default' => 'Lato',
																		'transport' => 'refresh' ) );
																
		$wp_customize->add_control( 'control_open_button_font', array(	'label' => 'Open Button Font',
																		'section' => 'section_fonts',
		...
		$wp_customize->get_setting( 'setting_open_button_font' )->transport = 'postMessage';
	}
...
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo $setting_text_logo_font; ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo $setting_text_slogan_font; ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo $setting_page_title_font; ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo $setting_content_font; ?>">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=<?php echo $setting_open_button_font; ?>">
