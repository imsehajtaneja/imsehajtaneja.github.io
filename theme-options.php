													...
													<table>
														...
														<tr>
															...
															<td class="option-right">
																...
																- Do not enter a url.
																<br>
																- Do the steps in the Documentation > Twitter Widget.
															</td>
														</tr>
													...
													<table>
														...
														<tr>
															<td class="option-left">
																...
																?>
																<input type="number" step="0.05" id="cover_heading_1_tune" name="cover_heading_1_tune" size="6" maxlength="6" value="<?php echo $cover_heading_1_tune; ?>">
														...
														<tr>
															<td class="option-left">
																...
																?>
																<input type="number" step="0.05" id="cover_heading_2_tune" name="cover_heading_2_tune" size="6" maxlength="6" value="<?php echo $cover_heading_2_tune; ?>">
														...
														<tr>
															<td class="option-left">
																...
																?>
																<input type="number" step="0.05" id="cover_heading_3_tune" name="cover_heading_3_tune" size="6" maxlength="6" value="<?php echo $cover_heading_3_tune; ?>">
														...
														<tr>
															<td class="option-left">
																...
																?>
																<input type="number" step="0.05" id="cover_heading_3_sub_tune" name="cover_heading_3_sub_tune" size="6" maxlength="6" value="<?php echo $cover_heading_3_sub_tune; ?>">
													...
													<table>
														...
														<tr>
															<td class="option-left">
																...
																?>
																<select id="resume_page_blog" name="resume_page_blog" style="width: 100%;">
